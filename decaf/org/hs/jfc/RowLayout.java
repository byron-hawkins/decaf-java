 ...
 */
class RowLayout implements java.io.Serializable
{
	...
	public void doLayout()	
	{
        ...
        if (m_followingRow != null)
        {
    		...
    		while (e.hasMoreElements())
    		{
                ((ComponentLayout)e.nextElement()).doLayout(room);
    		}
        }
	}
	 ...
	 */
    class ComponentLayout implements java.io.Serializable
    {
        ...
        {
            if ((m_anchor == null) || (m_anchor.getIndex() == RowLayout.this.getIndex())) 	//  no anchor || this is the anchor
            {
				int location = RowLayout.this.m_currLocation;
            ...
            if ((m_anchor == null) || (m_anchor.getIndex() != RowLayout.this.getIndex()))	//	no anchor || this is not the anchor
            {
                if ((m_anchor != null) && (m_anchor.getIndex() != RowLayout.this.getIndex())) //  this is the end of the multiRow
                {
                    room += (RowLayout.this.m_currLocation - m_anchor.getUpperBoundary());	
                }
                if (m_component.getPreferredSize().height <= room)
                {
