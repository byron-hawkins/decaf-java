...
public interface Variable extends Typed, Utils.Renderable, Decaf
{
	...
	{
		public JComponent getComponent(Variable data)
		{
			if (data == null)
			{
				return new Utils.RenderLabel("<null>");
			}
			return (new Utils.RenderLabel(data.getType().getDisplayName() + " " + data.getName()));
		}
	}
}