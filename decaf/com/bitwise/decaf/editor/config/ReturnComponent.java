    ...
    implements Element
{
        ...
        throws UnmarshalException
    {
        ...
        xs.takeEnd("ReturnComponent");
    }

    public static ReturnComponent unmarshal(InputStream in)
        throws UnmarshalException
    {
        return unmarshal(XMLScanner.open(in));
    }

    public static ReturnComponent unmarshal(XMLScanner xs)
        throws UnmarshalException
    {
        return unmarshal(xs, newDispatcher());
    }

    public static ReturnComponent unmarshal(XMLScanner xs, Dispatcher d)
        throws UnmarshalException
    {
        return ((ReturnComponent) d.unmarshal(xs, (ReturnComponent.class)));
    }
    ...
    public boolean equals(Object ob) {
        ...
        if (!(ob instanceof ReturnComponent)) {
            return false;
        }
        ReturnComponent tob = ((ReturnComponent) ob);
        if (_Classname!= null) {
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("<<ReturnComponent");
        if (_Classname!= null) {
            sb.append(" classname=");
