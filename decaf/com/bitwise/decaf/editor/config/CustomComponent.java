    ...
    implements Element
{
        ...
        throws UnmarshalException
    {
        ...
        xs.takeEnd("CustomComponent");
    }

    public static CustomComponent unmarshal(InputStream in)
        throws UnmarshalException
    {
        return unmarshal(XMLScanner.open(in));
    }

    public static CustomComponent unmarshal(XMLScanner xs)
        throws UnmarshalException
    {
    ...
    public static CustomComponent unmarshal(XMLScanner xs, Dispatcher d)
        throws UnmarshalException
    {
        return ((CustomComponent) d.unmarshal(xs, (CustomComponent.class)));
    }
    ...
    public boolean equals(Object ob) {
        ...
        CustomComponent tob = ((CustomComponent) ob);
        if (_Classname!= null) {
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("<<CustomComponent");
        if (_Classname!= null) {
            sb.append(" classname=");
