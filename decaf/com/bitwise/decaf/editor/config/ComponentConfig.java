...
public class ComponentConfig
    ...
    implements Element, FormComponent
{
        ...
        throws UnmarshalException
    {
        ...
        xs.takeEnd("ComponentConfig");
    }

    public static ComponentConfig unmarshal(InputStream in)
        throws UnmarshalException
    {
        return unmarshal(XMLScanner.open(in));
    }

    public static ComponentConfig unmarshal(XMLScanner xs)
        throws UnmarshalException
    {
        return unmarshal(xs, newDispatcher());
    }

    public static ComponentConfig unmarshal(XMLScanner xs, Dispatcher d)
        throws UnmarshalException
    {
        return ((ComponentConfig) d.unmarshal(xs, (ComponentConfig.class)));
    }
    ...
    public boolean equals(Object ob) {
        ...
        if (!(ob instanceof ComponentConfig)) {
            return false;
        }
        ComponentConfig tob = ((ComponentConfig) ob);
        if (_Classname!= null) {
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("<<ComponentConfig");
        if (_Classname!= null) {
            sb.append(" classname=");
