    ...
    implements Element
{
        ...
        throws UnmarshalException
    {
        ...
        xs.takeStart("ParameterComponents");
        ...
        xs.takeEnd("ParameterComponents");
    }

    public static ParameterComponents unmarshal(InputStream in)
        throws UnmarshalException
    {
        return unmarshal(XMLScanner.open(in));
    }

    public static ParameterComponents unmarshal(XMLScanner xs)
        throws UnmarshalException
    {
        return unmarshal(xs, newDispatcher());
    }

    public static ParameterComponents unmarshal(XMLScanner xs, Dispatcher d)
        throws UnmarshalException
    {
        return ((ParameterComponents) d.unmarshal(xs, (ParameterComponents.class)));
    }
    ...
    public boolean equals(Object ob) {
        ...
        if (!(ob instanceof ParameterComponents)) {
            return false;
        }
        ParameterComponents tob = ((ParameterComponents) ob);
        if (_NameComponent!= null) {
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("<<ParameterComponents");
        if (_NameComponent!= null) {
