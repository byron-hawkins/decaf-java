    ...
    implements Element
{
        ...
        throws UnmarshalException
    {
        ...
        xs.takeEnd("LocalComponents");
    }

    public static LocalComponents unmarshal(InputStream in)
        throws UnmarshalException
    {
        return unmarshal(XMLScanner.open(in));
    }

    public static LocalComponents unmarshal(XMLScanner xs)
        throws UnmarshalException
    {
    ...
    public static LocalComponents unmarshal(XMLScanner xs, Dispatcher d)
        throws UnmarshalException
    {
        return ((LocalComponents) d.unmarshal(xs, (LocalComponents.class)));
    }
    ...
    public boolean equals(Object ob) {
        ...
        if (!(ob instanceof LocalComponents)) {
            return false;
        }
        LocalComponents tob = ((LocalComponents) ob);
        if (_NameComponent!= null) {
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("<<LocalComponents");
        if (_NameComponent!= null) {
