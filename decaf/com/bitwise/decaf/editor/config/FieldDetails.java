...
public class FieldDetails extends Field
{
	...
	public boolean matches(Type.Field field)  // a Variable
	{
		return super.getName().equals(field.getName());
	}
    ...
    {
        return ((Field) d.unmarshal(xs, (FieldDetails.class)));
    }
}
