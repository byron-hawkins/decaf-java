    ...
    implements Element
{
        ...
        throws UnmarshalException
    {
        ...
        xs.takeEnd("TypeComponent");
    }

    public static TypeComponent unmarshal(InputStream in)
        throws UnmarshalException
    {
        return unmarshal(XMLScanner.open(in));
    }

    public static TypeComponent unmarshal(XMLScanner xs)
        throws UnmarshalException
    {
        return unmarshal(xs, newDispatcher());
    }

    public static TypeComponent unmarshal(XMLScanner xs, Dispatcher d)
        throws UnmarshalException
    {
        return ((TypeComponent) d.unmarshal(xs, (TypeComponent.class)));
    }
    ...
    public boolean equals(Object ob) {
        ...
        if (!(ob instanceof TypeComponent)) {
            return false;
        }
        TypeComponent tob = ((TypeComponent) ob);
        if (_Classname!= null) {
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("<<TypeComponent");
        if (_Classname!= null) {
            sb.append(" classname=");
