...
public class MethodConfig extends MethodComponents implements MaskConfig
{
	...
	public void initConstraints()
	{
		...
		getReturnConfig().initConstraints();
    ...
    {
        return ((MethodConfig) d.unmarshal(xs, (MethodConfig.class)));
    }
    ...
    {
    	return (ReturnConfig)super.getReturnComponent();
    }
